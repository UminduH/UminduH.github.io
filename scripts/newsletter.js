...
import { collection, addDoc, getDocs, query, where, limit } from 'https://www.gstatic.com/firebasejs/11.8.0/firebase-firestore.js';
      ...
      if (!isValidEmail) {
        ...
        try {
          ...
          if (!querySnapshot.empty) {
            ...
            messageDiv.textContent = "You're subscribed! Check your inbox for updates.";
